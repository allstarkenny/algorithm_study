...
def solution(nums):
    independent_data_len = len(set(nums))
    choice_len = len(nums) // 2
    return independent_data_len if choice_len > independent_data_len else choice_len

arr1 = [[3,1,2,3], [3,3,3,2,2,4], [3,3,3,2,2,2]]
return_list = [2, 3, 2]
